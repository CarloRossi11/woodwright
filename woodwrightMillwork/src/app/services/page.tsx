...
export default function Page() {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      >
      <h1>SERVICES</h1>
      <p>Tech Wrench provides web development, digital solutions, and technology support designed to help small businesses grow and stay ahead in a fast-changing world.</p>
    </HeroOverlay>
      ...
      <div className={styles.grow}>
        ...
        <ul>
          <li>
            Work with our design expert to create a new brand book, including:
          </li>
          <ul>
          ...
          <li>
            Create/update social media & google profiles
          </li>
          <ul>
            <li>Facebok</li>
            <li>Instagram</li>
